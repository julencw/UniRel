...
class RunArguments:
    ...
    test_data_nums: int = field(
        metadata={"help": "How much data to test."}, default=-1
    )
    ...
    test_data_path: str = field(
        metadata={"help": "Test specific data"}, default=None
    )
    ...
    is_separate_ablation: bool = field(
        metadata={
            "help": "Seperate encode text and predicate to do ablation study"
        },
        default=False,
    )
